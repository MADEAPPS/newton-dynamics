...
namespace ndRagdoll
{
	...
	static ndDefinition ragdollDefinition[] =
	{
		...
		{ "lhumerus", ndDefinition::m_hinge, 1.0f, { 0.0f, 120.0f, 0.0f }, { 0.0f, 90.0f, 0.0f } },
		...
		{ "rhumerus", ndDefinition::m_hinge, 1.0f, { 0.0f, 120.0f, 0.0f }, { 0.0f, 90.0f, 0.0f } },
		...
		{ "rfemur", ndDefinition::m_hinge, 1.0f, { 0.0f, 120.0f, 0.0f }, { 0.0f, 90.0f, 0.0f } },
		...
		{ "lfemur", ndDefinition::m_hinge, 1.0f, { 0.0f, 120.0f, 0.0f }, { 0.0f, 90.0f, 0.0f } },
