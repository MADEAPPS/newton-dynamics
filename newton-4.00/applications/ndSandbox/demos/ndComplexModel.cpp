...
class ndExcavatorController : public ndModelNotify
{
		...
		ndSharedPtr<ndRenderSceneNode>& visualMeshRoot)
	{
		...
		threadCollision->m_shapeMaterial.m_userId = m_thread;
...
class ExcavatorMaterial : public ndApplicationMaterial
{
	public:
	ExcavatorMaterial()
	...
	ExcavatorMaterial(const ExcavatorMaterial& src)
	...
	{
		return new ExcavatorMaterial(*this);
	}
...
void ndComplexModel(ndDemoEntityManager* const scene)
{
	...
	ExcavatorMaterial material;
	ndContactCallback* const callback = (ndContactCallback*)scene->GetWorld()->GetContactNotify();
	callback->RegisterMaterial(material, ndExcavatorController::m_thread, ndDemoContactCallback::m_default);
