...
class ndDGController : public ndModelNotify
{
    ...
    void NormalizeMassDistribution(ndFloat32 totalMass) const
    {
        ...
        for (const auto& part : m_bodypartlist)
        {
            ...
            ndFloat32 mass = density * ndMax(volume, 0.001f);
