...
#include "ndUserPlaneCollision.h"
...
class dInfinitePlane
{
	...
	public:
	static ndDemoMesh* CreateVisualMesh (const dVector& plane, ndDemoEntityManager* const scene)
	{
...
/*
	static DemoEntity* CreateVisualMesh (ndDemoEntityManager* const scene, const dVector& plane)
	{
		// make a visual entity
