...
#ifndef __ND_BODY_SPH_FLUID_FOR_OPENCL_H__
#define __ND_BODY_SPH_FLUID_FOR_OPENCL_H__
...
{
	public:
	D_NEWTON_API ndBodySphFluid_forOpenCL();
	D_NEWTON_API ndBodySphFluid_forOpenCL(const ndLoadSaveBase::ndLoadDescriptor& desc);
	D_NEWTON_API virtual ~ndBodySphFluid_forOpenCL ();
...
inline bool ndBodySphFluid_forOpenCL::RayCast(ndRayCastNotify&, const ndFastRay&, const ndFloat32) const
{
	return false;
}

inline ndFloat32 ndBodySphFluid_forOpenCL::CalculateGridSize() const
{
	//return m_radius * ndFloat32(2.0f);
	//return m_radius * ndFloat32(2.0f) * ndFloat32(1.125f);
	return m_radius * (ndFloat32(2.0f) * ndFloat32(4.0f));
}
