...
//void ndJointIkBallAndSocket::SetConeFriction(ndFloat32 regularizer, ndFloat32 viscousFriction)
//{
//	m_coneFriction = dAbs(viscousFriction);
//	m_coneFrictionRegularizer = dMax(dAbs(regularizer), ndFloat32(0.0f));
//}
//
//void ndJointIkBallAndSocket::SetTwistLimits(ndFloat32 minAngle, ndFloat32 maxAngle)
//{
//	m_minTwistAngle = dMin(minAngle, ndFloat32 (0.0f));
//	m_maxTwistAngle = dMax(maxAngle, ndFloat32(0.0f));
//}
//
//void ndJointIkBallAndSocket::SetTwistFriction(ndFloat32 regularizer, ndFloat32 viscousFriction)
//{
//	m_twistFriction = dAbs(viscousFriction);
//	m_twistFrictionRegularizer = dMax(dAbs(regularizer), ndFloat32(0.0f));
//}
//
//void ndJointIkBallAndSocket::GetTwistLimits(ndFloat32& minAngle, ndFloat32& maxAngle) const
//{
//	minAngle = m_minTwistAngle;
//	maxAngle = m_maxTwistAngle;
//}
//
//ndFloat32 ndJointIkBallAndSocket::GetMaxConeAngle() const
//{
//	return m_maxConeAngle;
//}
//
//void ndJointIkBallAndSocket::SetConeLimit(ndFloat32 maxConeAngle)
//{
...
void ndJointIkBallAndSocket::DebugJoint(ndConstraintDebugCallback&) const
{
	dAssert(0);
	//ndMatrix matrix0;
	//ndMatrix matrix1;
...
//void ndJointIkBallAndSocket::SubmitAngularAxisCartesianApproximation(const ndMatrix& matrix0, const ndMatrix& matrix1, ndConstraintDescritor& desc)
//{
...
//}
//
//void ndJointIkBallAndSocket::SubmitTwistAngle(const ndVector& pin, ndFloat32 angle, ndConstraintDescritor& desc)
//{
...
//}
//
//void ndJointIkBallAndSocket::SubmitAngularAxis(const ndMatrix& matrix0, const ndMatrix& matrix1, ndConstraintDescritor& desc)
//{
...
//void ndJointIkBallAndSocket::SubmitConeAngleOnlyRows(const ndMatrix& matrix0, const ndMatrix& matrix1, ndConstraintDescritor& desc)
//{
