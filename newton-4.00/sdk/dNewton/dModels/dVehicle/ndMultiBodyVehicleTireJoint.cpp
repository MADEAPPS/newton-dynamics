...
{
	m_frictionModel.m_laterialStiffness____ = ndMax(ndAbs(m_frictionModel.m_laterialStiffness____), ndFloat32(1.0f));
	m_frictionModel.m_longitudinalStiffness____ = ndMax(ndAbs(m_frictionModel.m_longitudinalStiffness____), ndFloat32(1.0f));
}
