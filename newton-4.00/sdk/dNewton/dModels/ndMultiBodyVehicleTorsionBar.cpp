...
ndMultiBodyVehicleTorsionBar::ndMultiBodyVehicleTorsionBar(ndWorld* const world, const ndMultiBodyVehicle* const vehicle)
	:ndJointBilateralConstraint(1, vehicle->m_chassis, world->GetSentinelBody(), dGetIdentityMatrix())
//	,m_chassis(chassis)
{
	dAssert(0);
