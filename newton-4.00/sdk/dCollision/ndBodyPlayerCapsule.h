...
{
	public:
	D_COLLISION_API ndBodyPlayerCapsule(const dClassLoaderBase::dDesc& desc);
	...
	protected: 
	D_COLLISION_API void Save(nd::TiXmlElement* const rootNode, const char* const assetPath, dInt32 shapeId) const;
