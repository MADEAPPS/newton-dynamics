...
{
	public:
	ND_COLLISION_API ntShapeBox(dFloat32 size_x, dFloat32 size_y, dFloat32 size_z);
	...
	ND_COLLISION_API virtual dFloat32 RayCast(ntRayCastNotify& callback, const dVector& localP0, const dVector& localP1, dFloat32 maxT, const ntBody* const body, ntContactPoint& contactOut) const;
