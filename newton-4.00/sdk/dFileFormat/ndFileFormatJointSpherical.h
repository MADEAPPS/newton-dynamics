...
#ifndef _ND_FILE_FORMAT_JOINT_SPHERICAL_H__
#define _ND_FILE_FORMAT_JOINT_SPHERICAL_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatJoint.h"

class ndFileFormatJointSpherical : public ndFileFormatJoint
{
	public: 
	ndFileFormatJointSpherical();
	ndFileFormatJointSpherical(const char* const className);
