...
#ifndef _ND_FILE_FORMAT_JOINT_PLANE_H__
#define _ND_FILE_FORMAT_JOINT_PLANE_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatJoint.h"

class ndFileFormatJointPlane : public ndFileFormatJoint
{
	public: 
	ndFileFormatJointPlane();
	ndFileFormatJointPlane(const char* const className);
