...
#ifndef _ND_FILE_FORMAT_SHAPE_CONVEX_CONE_H__
#define _ND_FILE_FORMAT_SHAPE_CONVEX_CONE_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatShapeConvex.h"

class ndFileFormatShapeConvexCone : public ndFileFormatShapeConvex
{
	public: 
