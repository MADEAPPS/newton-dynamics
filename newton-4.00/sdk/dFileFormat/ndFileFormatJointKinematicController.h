...
#ifndef _ND_FILE_FORMAT_JOINT_KINEMATIC_CONTROLLER_H__
#define _ND_FILE_FORMAT_JOINT_KINEMATIC_CONTROLLER_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatJoint.h"

class ndFileFormatJointKinematicController : public ndFileFormatJoint
{
	public: 
	ndFileFormatJointKinematicController();
	ndFileFormatJointKinematicController(const char* const className);
