...
#ifndef _ND_FILE_FORMAT_SHAPE_STATIC_PROCEDURAL_MESH_H__
#define _ND_FILE_FORMAT_SHAPE_STATIC_PROCEDURAL_MESH_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatShapeStaticMesh.h"

class ndFileFormatShapeStaticProceduralMesh : public ndFileFormatShapeStaticMesh
{
	public: 
