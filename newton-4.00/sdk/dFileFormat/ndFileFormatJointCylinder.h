...
#ifndef _ND_FILE_FORMAT_JOINT_CYLINDER_H__
#define _ND_FILE_FORMAT_JOINT_CYLINDER_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatJoint.h"

class ndFileFormatJointCylinder : public ndFileFormatJoint
{
	public: 
	ndFileFormatJointCylinder();
	ndFileFormatJointCylinder(const char* const className);
