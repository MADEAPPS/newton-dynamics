...
#ifndef _ND_FILE_FORMAT_JOINT_UP_VECTOR_H__
#define _ND_FILE_FORMAT_JOINT_UP_VECTOR_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatJoint.h"

class ndFileFormatJointUpVector : public ndFileFormatJoint
{
	public: 
	ndFileFormatJointUpVector();
	ndFileFormatJointUpVector(const char* const className);
