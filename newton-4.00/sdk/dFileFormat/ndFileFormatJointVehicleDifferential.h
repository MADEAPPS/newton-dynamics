...
#ifndef _ND_FILE_FORMAT_JOINT_VEHICLE_DIFFRENTIAL_H__
#define _ND_FILE_FORMAT_JOINT_VEHICLE_DIFFRENTIAL_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatJoint.h"

class ndFileFormatJointVehicleDifferential : public ndFileFormatJoint
{
	public: 
	ndFileFormatJointVehicleDifferential();
	ndFileFormatJointVehicleDifferential(const char* const className);
