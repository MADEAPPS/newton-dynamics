...
#ifndef _ND_FILE_FORMAT_JOINT_VEHICLE_TIRE_H__
#define _ND_FILE_FORMAT_JOINT_VEHICLE_TIRE_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatJointWheel.h"

class ndFileFormatJointVehicleTire : public ndFileFormatJointWheel
{
	public: 
	ndFileFormatJointVehicleTire();
	ndFileFormatJointVehicleTire(const char* const className);
