...
#ifndef _ND_FILE_FORMAT_JOINT_FIX_6DOF_H__
#define _ND_FILE_FORMAT_JOINT_FIX_6DOF_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatJoint.h"

class ndFileFormatJointFix6dof : public ndFileFormatJoint
{
	public: 
	ndFileFormatJointFix6dof();
	ndFileFormatJointFix6dof(const char* const className);
