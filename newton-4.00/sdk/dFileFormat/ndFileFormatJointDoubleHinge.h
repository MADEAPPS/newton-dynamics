...
#ifndef _ND_FILE_FORMAT_JOINT_DOUBLE_HINGE_H__
#define _ND_FILE_FORMAT_JOINT_DOUBLE_HINGE_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatJoint.h"

class ndFileFormatJointDoubleHinge : public ndFileFormatJoint
{
	public: 
	ndFileFormatJointDoubleHinge();
	ndFileFormatJointDoubleHinge(const char* const className);
