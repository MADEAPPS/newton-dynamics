...
void ndFileFormatShapeConvexCylinder::SaveShape(nd::TiXmlElement* const parentNode, const ndShape* const shape)
{
	nd::TiXmlElement* const classNode = new nd::TiXmlElement(ndShapeCylinder::StaticClassName());
