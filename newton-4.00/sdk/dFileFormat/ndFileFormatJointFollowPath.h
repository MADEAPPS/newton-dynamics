...
#ifndef _ND_FILE_FORMAT_JOINT_FOLLOW_PATH_H__
#define _ND_FILE_FORMAT_JOINT_FOLLOW_PATH_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatJoint.h"

class ndFileFormatJointFollowPath : public ndFileFormatJoint
{
	public: 
	ndFileFormatJointFollowPath();
	ndFileFormatJointFollowPath(const char* const className);
