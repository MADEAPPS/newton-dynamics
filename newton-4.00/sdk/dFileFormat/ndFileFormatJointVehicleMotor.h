...
#ifndef _ND_FILE_FORMAT_JOINT_VEHICLE_MOTOR_H__
#define _ND_FILE_FORMAT_JOINT_VEHICLE_MOTOR_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatJoint.h"

class ndFileFormatJointVehicleMotor : public ndFileFormatJoint
{
	public: 
	ndFileFormatJointVehicleMotor();
	ndFileFormatJointVehicleMotor(const char* const className);
