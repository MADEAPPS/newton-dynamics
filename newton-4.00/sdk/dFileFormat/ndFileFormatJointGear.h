...
#ifndef _ND_FILE_FORMAT_JOINT_GEAR_H__
#define _ND_FILE_FORMAT_JOINT_GEAR_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatJoint.h"

class ndFileFormatJointGear : public ndFileFormatJoint
{
	public: 
	ndFileFormatJointGear();
	ndFileFormatJointGear(const char* const className);
