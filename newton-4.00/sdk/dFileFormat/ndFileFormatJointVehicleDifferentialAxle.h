...
#ifndef _ND_FILE_FORMAT_JOINT_VEHICLE_DIFFRENTIAL_AXLE_H__
#define _ND_FILE_FORMAT_JOINT_VEHICLE_DIFFRENTIAL_AXLE_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatJoint.h"

class ndFileFormatJointVehicleDifferentialAxle : public ndFileFormatJoint
{
	public: 
	ndFileFormatJointVehicleDifferentialAxle();
	ndFileFormatJointVehicleDifferentialAxle(const char* const className);
