...
#ifndef _ND_FILE_FORMAT_SHAPE_STATIC_HEIGHTFIELD_H__
#define _ND_FILE_FORMAT_SHAPE_STATIC_HEIGHTFIELD_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatShapeStaticMesh.h"

class ndFileFormatShapeStaticHeightfield : public ndFileFormatShapeStaticMesh
{
	public: 
