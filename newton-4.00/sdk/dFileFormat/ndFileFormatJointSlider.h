...
#ifndef _ND_FILE_FORMAT_JOINT_SLIDER_H__
#define _ND_FILE_FORMAT_JOINT_SLIDER_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatJoint.h"

class ndFileFormatJointSlider : public ndFileFormatJoint
{
	public: 
	ndFileFormatJointSlider();
	ndFileFormatJointSlider(const char* const className);
