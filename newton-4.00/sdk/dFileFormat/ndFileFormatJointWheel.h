...
#ifndef _ND_FILE_FORMAT_JOINT_WHEEL_H__
#define _ND_FILE_FORMAT_JOINT_WHEEL_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatJoint.h"

class ndFileFormatJointWheel : public ndFileFormatJoint
{
	public: 
	ndFileFormatJointWheel();
	ndFileFormatJointWheel(const char* const className);
