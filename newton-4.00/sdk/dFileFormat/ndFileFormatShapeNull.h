...
#ifndef _ND_FILE_FORMAT_SHAPE_NULL_H__
#define _ND_FILE_FORMAT_SHAPE_NULL_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatShape.h"

class ndFileFormatShapeNull : public ndFileFormatShape
{
	public: 
	ndFileFormatShapeNull();
	ndFileFormatShapeNull(const char* const className);
