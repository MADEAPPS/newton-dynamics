...
#ifndef _ND_FILE_FORMAT_JOINT_IK_HINGE_H__
#define _ND_FILE_FORMAT_JOINT_IK_HINGE_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatJointHinge.h"

class ndFileFormatJointIkHinge : public ndFileFormatJointHinge
{
	public: 
	ndFileFormatJointIkHinge();
	ndFileFormatJointIkHinge(const char* const className);
