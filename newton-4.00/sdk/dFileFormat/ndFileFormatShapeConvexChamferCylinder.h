...
#ifndef _ND_FILE_FORMAT_SHAPE_CONVEX_CHAMFERED_CYLINDER_H__
#define _ND_FILE_FORMAT_SHAPE_CONVEX_CHAMFERED_CYLINDER_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatShapeConvex.h"

class ndFileFormatShapeConvexChamferCylinder : public ndFileFormatShapeConvex
{
	public: 
