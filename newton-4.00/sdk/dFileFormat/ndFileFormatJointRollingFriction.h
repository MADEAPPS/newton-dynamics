...
#ifndef _ND_FILE_FORMAT_JOINT_ROLLING_FRICTION_H__
#define _ND_FILE_FORMAT_JOINT_ROLLING_FRICTION_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatJoint.h"

class ndFileFormatJointRollingFriction : public ndFileFormatJoint
{
	public: 
	ndFileFormatJointRollingFriction();
	ndFileFormatJointRollingFriction(const char* const className);
