...
#ifndef _ND_FILE_FORMAT_JOINT_HINGE_H__
#define _ND_FILE_FORMAT_JOINT_HINGE_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatJoint.h"

class ndFileFormatJointHinge : public ndFileFormatJoint
{
	public: 
	ndFileFormatJointHinge();
	ndFileFormatJointHinge(const char* const className);
