...
#ifndef _ND_FILE_FORMAT_SHAPE_CONVEX_BOX_H__
#define _ND_FILE_FORMAT_SHAPE_CONVEX_BOX_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatShapeConvex.h"

class ndFileFormatShapeConvexBox : public ndFileFormatShapeConvex
{
	public: 
	ndFileFormatShapeConvexBox();
	ndFileFormatShapeConvexBox(const char* const className);
