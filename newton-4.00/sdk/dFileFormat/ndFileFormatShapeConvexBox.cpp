...
ndFileFormatShapeConvexBox::ndFileFormatShapeConvexBox()
	:ndFileFormatShapeConvex(ndShapeBox::StaticClassName())
{
}

ndFileFormatShapeConvexBox::ndFileFormatShapeConvexBox(const char* const className)
	:ndFileFormatShapeConvex(className)
{
}

void ndFileFormatShapeConvexBox::SaveShape(ndFileFormat* const scene, nd::TiXmlElement* const parentNode, const ndShape* const shape)
{
