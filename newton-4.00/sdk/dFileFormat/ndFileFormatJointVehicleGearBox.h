...
#ifndef _ND_FILE_FORMAT_JOINT_VEHICLE_GEAR_BOX_H__
#define _ND_FILE_FORMAT_JOINT_VEHICLE_GEAR_BOX_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatJointGear.h"

class ndFileFormatJointVehicleGearBox : public ndFileFormatJointGear
{
	public: 
	ndFileFormatJointVehicleGearBox();
	ndFileFormatJointVehicleGearBox(const char* const className);
