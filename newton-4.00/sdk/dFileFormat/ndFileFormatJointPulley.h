...
#ifndef _ND_FILE_FORMAT_JOINT_PULLEY_H__
#define _ND_FILE_FORMAT_JOINT_PULLEY_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatJoint.h"

class ndFileFormatJointPulley : public ndFileFormatJoint
{
	public: 
	ndFileFormatJointPulley();
	ndFileFormatJointPulley(const char* const className);
