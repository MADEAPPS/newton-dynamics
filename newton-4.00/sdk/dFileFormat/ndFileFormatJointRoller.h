...
#ifndef _ND_FILE_FORMAT_JOINT_ROLLER_H__
#define _ND_FILE_FORMAT_JOINT_ROLLER_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatJoint.h"

class ndFileFormatJointRoller : public ndFileFormatJoint
{
	public: 
	ndFileFormatJointRoller();
	ndFileFormatJointRoller(const char* const className);
