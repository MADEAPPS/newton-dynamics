...
#ifndef _ND_FILE_FORMAT_JOINT_VEHICLE_TORSION_BAR_H__
#define _ND_FILE_FORMAT_JOINT_VEHICLE_TORSION_BAR_H__

#include "ndFileFormatStdafx.h"
#include "ndFileFormatJoint.h"

class ndFileFormatJointVehicleTorsionBar : public ndFileFormatJoint
{
	public: 
	ndFileFormatJointVehicleTorsionBar();
	ndFileFormatJointVehicleTorsionBar(const char* const className);
