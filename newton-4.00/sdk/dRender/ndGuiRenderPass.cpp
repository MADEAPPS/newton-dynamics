...
ndGuiRenderPass::ndGuiRenderPass(ndRender* const owner)
	:ndRenderPass(owner)
{
}

ndGuiRenderPass::~ndGuiRenderPass()
{
}

void ndGuiRenderPass::StateBegin()
{
	ndRenderContext* const context = *m_owner->m_context;
	context->SetGuiRenderStates();
}

void ndGuiRenderPass::StateEnd()
{
	ndRenderContext* const context = *m_owner->m_context;
...
#if 0
void ndGuiRenderPass::RenderScene(ndFloat32 timestep)
{
