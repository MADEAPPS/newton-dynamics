...
#ifndef _ND_BRAIN_TRAINER_OLD_H__
#define _ND_BRAIN_TRAINER_OLD_H__

#include "ndBrainStdafx.h"
#include "ndBrainTypes.h"
#include "ndBrainTrainerBase.h"

class ndBrainTrainer_old: public ndBrainTrainerBase
{
	public: 
	ndBrainTrainer_old(ndBrain* const brain);
	ndBrainTrainer_old(const ndBrainTrainer_old& src);
	virtual ~ndBrainTrainer_old();
...
inline ndReal ndBrainTrainer_old::GetRegularizer() const
{
	return m_regularizer;
}

inline void ndBrainTrainer_old::SetRegularizer(ndReal regularizer)
{
