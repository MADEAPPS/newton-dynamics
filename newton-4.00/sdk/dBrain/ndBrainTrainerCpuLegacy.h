...
#ifndef _ND_BRAIN_TRAINER_CPU_LEGACY_H__
#define _ND_BRAIN_TRAINER_CPU_LEGACY_H__
...
class ndBrainTrainerCpuLegacy: public ndBrainTrainer
{
	public: 
	class ndLayerData;

	ndBrainTrainerCpuLegacy(const ndSharedPtr<ndBrain>& brain);
	...
	void AddGradients(const ndBrainTrainerCpuLegacy* const src);
	void CopyGradients(const ndBrainTrainerCpuLegacy* const src);
