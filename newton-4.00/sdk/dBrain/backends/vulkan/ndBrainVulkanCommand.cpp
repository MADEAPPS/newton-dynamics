...
#include "ndBrainVulkanCommand.h"
#include "ndBrainVulkanContext.h"


#if 1
ndBrainVulkanCommand::ndBrainVulkanCommand(ndBrainGpuContext* const context)
	:ndClassAlloc()
	,m_context(context)
...
ndBrainVulkanCommand::~ndBrainVulkanCommand()
{
	ndAssert(0);
...
void ndBrainVulkanCommand::Assembly(VkShaderModule shader, ndInt32 workGroups, ndInt32 paramCount, ndBrainGpuBuffer** params)
{
	ndAssert(0);
...
//ndBrainVulkanCommandTest::ndBrainVulkanCommandTest(ndBrainGpuContext* const context,
//	ndBrainGpuUniformBuffer& parammeters,
//	ndBrainGpuFloatBuffer& input, ndBrainGpuFloatBuffer& output)
//	:ndBrainVulkanCommand(context)
//{
