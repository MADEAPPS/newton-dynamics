...
class brainLayerBrainBackPropagateMatrixWeightBiasGradients : public ndBrainKernel
{
    public:
    brainLayerBrainBackPropagateMatrixWeightBiasGradients(ndBrainContext* const context)
        :ndBrainKernel(context)
    {
    }
...
{   
    ...
    m_brainLayerMatrixBackPropagateWeightAndBiasGradients = ndSharedPtr<ndBrainKernel>(new brainLayerBrainBackPropagateMatrixWeightBiasGradients(this));
