...
{
	ndList<ndBrainAgentContinuePolicyGradient_Trainer::ndRandomGenerator>::ndNode* const node = m_randomGenerator.Append();
	ndBrainAgentContinuePolicyGradient_Trainer::ndRandomGenerator* const generator = &node->GetInfo();
