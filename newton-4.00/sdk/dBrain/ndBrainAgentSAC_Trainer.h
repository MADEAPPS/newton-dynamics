...
class ndBrainAgentSAC_Trainer: public ndBrainAgentDDPG_Trainer<statesDim, actionDim>
{
	public:
...
void ndBrainAgentSAC_Trainer<statesDim, actionDim>::BackPropagate()
{
	...
	ndAssert(0);
	ndBrainAgentSAC_Trainer<statesDim, actionDim>::BackPropagateCritic(shuffleBuffer);

#ifdef USED_NEWTON_TD3_TWIST_VERSION
	ndBrainAgentSAC_Trainer<statesDim, actionDim>::BackPropagateActor(shuffleBuffer);
