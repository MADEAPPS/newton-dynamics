...
class ndBrainAgentSoftActorCritic_Agent : public ndBrainAgentDeterministicPolicyGradient_Trainer
{
	public:
	ndBrainAgentSoftActorCritic_Agent(const HyperParameters& parameters);
	virtual ~ndBrainAgentSoftActorCritic_Agent();
};
