...
template<ndInt32 statesDim, ndInt32 actionDim>
void ndBrainAgentDDPG_Trainner<statesDim, actionDim>::GetAction(ndReal* const actionSpace) const
{
	actionSpace[0] = ndReal(m_currentTransition.m_action[0]);
}

template<ndInt32 statesDim, ndInt32 actionDim>
ndInt32 ndBrainAgentDDPG_Trainner<statesDim, actionDim>::GetExploreExploitAction()
{
	ndInt32 action = 0;
	...
	{
		ndReal maxAction;
		ndBrainAgentDDPG<statesDim, actionDim>::GetAction(&maxAction);
