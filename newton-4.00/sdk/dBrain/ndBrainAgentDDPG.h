...
//bool ndBrainAgentDDPG<statesDim, actionDim>::Load(const char* const)
//{
//	ndAssert(0);
//	return false;
//}
...
template<ndInt32 statesDim, ndInt32 actionDim>
void ndBrainAgentDDPG<statesDim, actionDim>::SaveInternal(ndBrainLoadSave* const loadSave) const
{
