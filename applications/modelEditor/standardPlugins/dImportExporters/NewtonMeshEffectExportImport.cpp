...
#if 0
NewtonMeshEffectExport::Property* NewtonMeshEffectExport::PropertyList::GetProperty (const char* name)
{
	_ASSERTE (0);

	unsigned crc = dCRC (name);
	for (NewtonMeshEffectExport::PropertyList::dListNode* node = GetFirst(); node; node = node->GetNext()) {
...
/*
void NewtonMeshEffectExport::AddModel (dModel* model, dScene* world)
{
...
void NewtonMeshEffectExport::AddSkeleton (dBone* bone, dModel* model, dScene* world, dScene::dTreeNode* parentNode, dTree<dScene::dTreeNode*, int>& sceneNodes)
{
...
void NewtonMeshEffectExport::CreateMeshGeomtry (dScene::dTreeNode* meshNode, dMesh* mesh, dScene* world)
{
	int materialID = 0;
...
void NewtonMeshEffectExport::SkipChar (FILE* file, char chr)
{
	while (!feof (file) && getc (file) != chr);	
}

int NewtonMeshEffectExport::NextChar (FILE* file)
{
	_ASSERTE (0);
	return 0;
/*
...
/*
void NewtonMeshEffectExport::SkipClass (FILE* file)
{
...
void NewtonMeshEffectExport::ReadProperties (FILE* file, dList<Property>& list)
{
	int ch;
...
void NewtonMeshEffectExport::LoadVersionInfo(FILE* file, dScene* world, void* userData)
{
	SkipClass (file);
}

void NewtonMeshEffectExport::LoadVisGroups(FILE* file, dScene* world, void* userData)
{
	SkipClass (file);
}
...
void NewtonMeshEffectExport::LoadViewSettings(FILE* file, dScene* world, void* userData)
{
	SkipClass (file);
}
...
void NewtonMeshEffectExport::LoadEntity (FILE* file, dScene* world, void* userData)
{
	SkipClass (file);
}

void NewtonMeshEffectExport::LoadCamera (FILE* file, dScene* world, void* userData)
{
	SkipClass (file);
}

void NewtonMeshEffectExport::LoadCordon (FILE* file, dScene* world, void* userData)
{
	SkipClass (file);
}
...
void NewtonMeshEffectExport::LoadSide (FILE* file, dScene* world, void* userData)
{
	SkipChar (file, '{');
...
void NewtonMeshEffectExport::LoadSolid (FILE* file, dScene* world, void* userData)
{
	SkipChar (file, '{');
...
void NewtonMeshEffectExport::LoadWorld (FILE* file, dScene* world, void* userData)
{
	SkipChar (file, '{');
	PropertyList propertyList;
	ReadProperties (file, propertyList);
...
void NewtonMeshEffectExport::ParceMapFile (FILE* file, dScene* world, void* userData)
{
	_ASSERTE (0);
/*
	char className[64];
