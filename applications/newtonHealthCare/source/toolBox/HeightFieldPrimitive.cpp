...
//		MakeCalderas (elevation, size, maxElevation * 0.7f, maxElevation * 0.1f);
		...
		//collision = TestSerialization ("treeCollision.bin", collision, scene->GetNewton());
	...
	NewtonBody* const terrainBody = NewtonCreateBody(scene->GetNewton(), collision, &matrix[0][0]);
