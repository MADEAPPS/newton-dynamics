...
dVector GetCameraDir ()
{
	return gCurrCameraDir;
}

dFloat GetCameraYawAngle ()
{
	return gYawAngle;
}
...
{
	return gCameraEyepoint;
}


void SetCameraEyePoint (const dVector& eyepoint)
{
	gCameraEyepoint = eyepoint;
}

/*
dVector GetPrevCameraEyePoint ()
{
	return gPrevCameraEyepoint;
}

void SetPrevCameraEyePoint (const dVector& eyepoint)
{
	gPrevCameraEyepoint = eyepoint;
}
*/
