...
#ifndef _D_STANDARD_MODELS_GLUE_H_
#define _D_STANDARD_MODELS_GLUE_H_

#ifdef STANDARD_MODELS_PLUGIN_EXPORTS
...
class dPluginRecord;
extern "C" 	Plugin_API dPluginRecord** GetPluginArray();
