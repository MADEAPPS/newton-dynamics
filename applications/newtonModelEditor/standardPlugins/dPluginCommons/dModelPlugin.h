...
#ifndef __D_MODEL_PLUGIN_H__
#define __D_MODEL_PLUGIN_H__

#include "dPluginRecord.h"

class dPluginInterface;

class dModelPlugin: public dPluginRecord
{
public:
	dModelPlugin(void) {};
	virtual ~dModelPlugin(void) {};

	virtual dPluginType GetType () { return m_model;}
