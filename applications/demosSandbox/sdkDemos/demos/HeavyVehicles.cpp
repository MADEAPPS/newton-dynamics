...
class HeavyVehicleEntity: public DemoEntity
{
	...
	void BuildAllWheelDriveVehicle ()
	{
		...
		CustomVehicleControllerBodyStateTire* const leftTire0 = AddTire ("ltire_0", offset, width, radius, HEAVY_TRANSPORT_TIRE_MASS, HEAVY_TRANSPORT_SUSPENSION_LENGTH, HEAVY_TRANSPORT_SUSPENSION_SPRING, HEAVY_TRANSPORT_SUSPENSION_DAMPER, HEAVY_TRANSPORT_LATERAL_STIFFNESS, HEAVY_TRANSPORT_LONGITUDINAL_STIFFNESS, HEAVY_TRANSPORT_ALIGNING_MOMENT_TRAIL);
		CustomVehicleControllerBodyStateTire* const leftTire1 = AddTire ("ltire_1", offset, width, radius, HEAVY_TRANSPORT_TIRE_MASS, HEAVY_TRANSPORT_SUSPENSION_LENGTH, HEAVY_TRANSPORT_SUSPENSION_SPRING, HEAVY_TRANSPORT_SUSPENSION_DAMPER, HEAVY_TRANSPORT_LATERAL_STIFFNESS, HEAVY_TRANSPORT_LONGITUDINAL_STIFFNESS, HEAVY_TRANSPORT_ALIGNING_MOMENT_TRAIL);
		CustomVehicleControllerBodyStateTire* const leftTire2 = AddTire ("ltire_2", offset, width, radius, HEAVY_TRANSPORT_TIRE_MASS, HEAVY_TRANSPORT_SUSPENSION_LENGTH, HEAVY_TRANSPORT_SUSPENSION_SPRING, HEAVY_TRANSPORT_SUSPENSION_DAMPER, HEAVY_TRANSPORT_LATERAL_STIFFNESS, HEAVY_TRANSPORT_LONGITUDINAL_STIFFNESS, HEAVY_TRANSPORT_ALIGNING_MOMENT_TRAIL);
		CustomVehicleControllerBodyStateTire* const leftTire3 = AddTire ("ltire_3", offset, width, radius, HEAVY_TRANSPORT_TIRE_MASS, HEAVY_TRANSPORT_SUSPENSION_LENGTH, HEAVY_TRANSPORT_SUSPENSION_SPRING, HEAVY_TRANSPORT_SUSPENSION_DAMPER, HEAVY_TRANSPORT_LATERAL_STIFFNESS, HEAVY_TRANSPORT_LONGITUDINAL_STIFFNESS, HEAVY_TRANSPORT_ALIGNING_MOMENT_TRAIL);

		CustomVehicleControllerBodyStateTire* const rightTire0 = AddTire ("rtire_0", offset, width, radius, HEAVY_TRANSPORT_TIRE_MASS, HEAVY_TRANSPORT_SUSPENSION_LENGTH, HEAVY_TRANSPORT_SUSPENSION_SPRING, HEAVY_TRANSPORT_SUSPENSION_DAMPER, HEAVY_TRANSPORT_LATERAL_STIFFNESS, HEAVY_TRANSPORT_LONGITUDINAL_STIFFNESS, HEAVY_TRANSPORT_ALIGNING_MOMENT_TRAIL);
		CustomVehicleControllerBodyStateTire* const rightTire1 = AddTire ("rtire_1", offset, width, radius, HEAVY_TRANSPORT_TIRE_MASS, HEAVY_TRANSPORT_SUSPENSION_LENGTH, HEAVY_TRANSPORT_SUSPENSION_SPRING, HEAVY_TRANSPORT_SUSPENSION_DAMPER, HEAVY_TRANSPORT_LATERAL_STIFFNESS, HEAVY_TRANSPORT_LONGITUDINAL_STIFFNESS, HEAVY_TRANSPORT_ALIGNING_MOMENT_TRAIL);
		CustomVehicleControllerBodyStateTire* const rightTire2 = AddTire ("rtire_2", offset, width, radius, HEAVY_TRANSPORT_TIRE_MASS, HEAVY_TRANSPORT_SUSPENSION_LENGTH, HEAVY_TRANSPORT_SUSPENSION_SPRING, HEAVY_TRANSPORT_SUSPENSION_DAMPER, HEAVY_TRANSPORT_LATERAL_STIFFNESS, HEAVY_TRANSPORT_LONGITUDINAL_STIFFNESS, HEAVY_TRANSPORT_ALIGNING_MOMENT_TRAIL);
		CustomVehicleControllerBodyStateTire* const rightTire3 = AddTire ("rtire_3", offset, width, radius, HEAVY_TRANSPORT_TIRE_MASS, HEAVY_TRANSPORT_SUSPENSION_LENGTH, HEAVY_TRANSPORT_SUSPENSION_SPRING, HEAVY_TRANSPORT_SUSPENSION_DAMPER, HEAVY_TRANSPORT_LATERAL_STIFFNESS, HEAVY_TRANSPORT_LONGITUDINAL_STIFFNESS, HEAVY_TRANSPORT_ALIGNING_MOMENT_TRAIL);
