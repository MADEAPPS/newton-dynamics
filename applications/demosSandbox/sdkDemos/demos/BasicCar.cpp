...
void BasicCar (DemoEntityManager* const scene)
{
	...
	BasicVehicleEntity* const vehicle = new BasicVehicleEntity (scene, manager, location, "lambDiablo.ngd");
...
//	location.m_z += 20.0f;
	...
	AddPrimitiveArray(scene, 500.0f, location.m_posit, size, count, count, 5.0f, _BOX_PRIMITIVE, defaultMaterialID, shapeOffsetMatrix);
