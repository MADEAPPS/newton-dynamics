...
/*
	...
	dThreeAdressStmt& startLabel = cil.NewStatement()->GetInfo();
	startLabel.m_instruction = dThreeAdressStmt::m_goto;
	...
	for (dList<dDAGFunctionStatementCase*>::dListNode* node = m_caseList.GetFirst(); node; node = node->GetNext()) {
		...
		dThreeAdressStmt& caseLabelStmt = cil.NewStatement()->GetInfo();
		caseLabelStmt.m_instruction = dThreeAdressStmt::m_label;
	...
	dThreeAdressStmt& startSwitchStmt = cil.NewStatement()->GetInfo();
	startSwitchStmt.m_instruction = dThreeAdressStmt::m_label;
	...
	dThreeAdressStmt& exitStmt = cil.NewStatement()->GetInfo();
	exitStmt.m_instruction = dThreeAdressStmt::m_label;
