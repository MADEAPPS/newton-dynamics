...
NVMAsmPrinter::NVMAsmPrinter (llvm::TargetMachine &TM, llvm::MCStreamer &Streamer)
	:llvm::AsmPrinter(TM, Streamer) 
{
	dAssert (0);
}

const char *NVMAsmPrinter::getPassName() const
{
	dAssert (0);
	return "Newton Vistual Machine Assembly Printer";
}

const char *NVMAsmPrinter::getRegisterName(unsigned RegNo) 
{
	dAssert (0);
return NULL;
