...
int CustomVehicleController::EngineComponent::GearBox::GetGear() const 
{
	return m_currentGear->m_id;
}

int CustomVehicleController::EngineComponent::GearBox::GetGearCount() const 
{
	return m_gearsCount;
}
...
dFloat CustomVehicleController::EngineComponent::GetInertia() const
{
	return m_momentOfInertia;
}

void CustomVehicleController::EngineComponent::SetInertia(dFloat inertia)
{
...
dFloat CustomVehicleController::EngineComponent::GetTorque (dFloat radianPerSeconds) const
{
...
dFloat CustomVehicleController::EngineComponent::GetDifferencialGearRatio() const
{
...
void CustomVehicleController::VehicleJoint::AddAngularRowJacobian (ParamInfo* const constraintParams, const dVector& dir, dFloat jointAngle)
{
	int index = constraintParams->m_count;
	Jacobian &jacobian0 = constraintParams->m_jacobians[index].m_jacobian_IM0; 
...
void CustomVehicleController::VehicleJoint::AddAngularRowJacobian (ParamInfo* const constraintParams, const dVector& dir0, const dVector& dir1, dFloat accelerationRatio)
{
	int index = constraintParams->m_count;
	Jacobian &jacobian0 = constraintParams->m_jacobians[index].m_jacobian_IM0; 
...
void CustomVehicleController::EngineIdleJoint::JacobianDerivative (ParamInfo* const constraintParams)
{
...
int CustomVehicleController::EngineBodyState::CalculateActiveJoints (CustomVehicleController* const controller, VehicleJoint** const jointArray)
{
    EngineComponent* const engine = controller->GetEngine();
...
void CustomVehicleController::EngineBodyState::CalculateAverageAcceleration (dFloat invTimestep, const dVector& veloc, const dVector& omega)
{
...
{
    EngineComponent* const engine = controller->GetEngine();
    EngineComponent::GearBox* const gearBox = engine->GetGearBox();
