...
dgCollisionDeformableClothPatch::dgParticle::dgParticle (dgInt32 particlesCount)
...
dgCollisionDeformableClothPatch::dgParticle::dgParticle(const dgParticle& source)
	:m_com (source.m_com) 
...
dgCollisionDeformableClothPatch::dgParticle::dgParticle (dgWorld* const world, dgDeserialize deserialization, void* const userData)
{
	dgAssert (0);
}

dgCollisionDeformableClothPatch::dgParticle::~dgParticle()
{
	dgFree (m_mass);
	dgFree (m_invMass);
	dgFree (m_position);
...
class dgCollisionDeformableClothPatch::dgDeformationRegion
{
	public:

	void Init(dgInt32 count, dgInt16* indexList, const dgCollisionDeformableClothPatch::dgParticle& particles)
	{
		dgAssert (!m_indices);
		m_count = count;
	...
	void Update(const dgCollisionDeformableClothPatch::dgParticle& particles)
	{
		...
		dgVector accSum (dgFloat32 (0.0f), dgFloat32 (0.0f), dgFloat32 (0.0f), dgFloat32 (0.0f));
		for (dgInt32 i = 0; i < m_count; i ++) {
		...
		if (m_totalMass > dgFloat32 (0.0f)) {
			...
			for (dgInt32 i = 0; i < m_count; i ++) {
				dgInt32 index = m_indices[i];
				dgVector qi (particles.m_shapePosition[index] - m_com0);
				dgFloat32 mass = particles.m_mass[index];
	...
	void UpdateVelocities(const dgCollisionDeformableClothPatch::dgParticle& particles, dgFloat32 timestep, dgFloat32 stiffness)
	{
...
class dgCollisionDeformableClothPatch::dgDeformableNode
{
	public:
	dgDeformableNode ()
	{
...
void dgCollisionDeformableClothPatch::SetCollisionBBox (const dgVector& p0, const dgVector& p1)
{
...
/*
void dgCollisionDeformableClothPatch::GetVertexListIndexList (const dgVector& p0, const dgVector& p1, dgGetVertexListIndexList &data) const
{
	dgAssert (0);
...
dgFloat32 dgCollisionDeformableClothPatch::RayCastSimd (const dgVector& localP0, const dgVector& localP1, dgContactPoint& contactOut, const dgBody* const body, void* const userData) const
{
dgAssert (0);
return 0;
...
dgFloat32 dgCollisionDeformableClothPatch::RayCast (const dgVector& localP0, const dgVector& localP1, dgContactPoint& contactOut, const dgBody* const body, void* const userData) const
{
dgAssert (0);
return 0;
/*
...
void dgCollisionDeformableClothPatch::GetCollidingFacesSimd (dgPolygonMeshDesc* const data) const
{
	dgAssert (0);
//	GetCollidingFaces (data);
}

void dgCollisionDeformableClothPatch::GetCollidingFaces (dgPolygonMeshDesc* const data) const
{
	dgAssert (0);
/*
	data->m_faceCount = 0;
...
dgInt32 dgCollisionDeformableClothPatch::GetVisualPointsCount() const
{
	return m_visualVertexCount;
}

void dgCollisionDeformableClothPatch::CreateRegions()
{
...
dgFloat32 dgCollisionDeformableClothPatch::CalculateSurfaceArea (const dgDeformableNode* const node0, const dgDeformableNode* const node1, dgVector& minBox, dgVector& maxBox) const
{
...
dgCollisionDeformableClothPatch::dgDeformableNode* dgCollisionDeformableClothPatch::BuildTopDown (dgInt32 count, dgDeformableNode* const children, dgDeformableNode* const parent)
{
...
bool dgCollisionDeformableClothPatch::SanityCheck () const
{
...
void dgCollisionDeformableClothPatch::ImproveNodeFitness (dgDeformableNode* const node)
{
...
void dgCollisionDeformableClothPatch::ImproveTotalFitness()
{
...
/*
void dgCollisionDeformableClothPatch::CalculateInertia (dgVector& inertiaOut, dgVector& originOut) const
{
...
void dgCollisionDeformableClothPatch::UpdateVisualNormals()
{
	for (dgInt32 i = 0; i < m_trianglesCount; i ++)	{
...
void dgCollisionDeformableClothPatch::GetVisualVertexData(
...
void* dgCollisionDeformableClothPatch::GetFirtVisualSegment() const
{
	return m_visualSegments.GetFirst();
}

void* dgCollisionDeformableClothPatch::GetNextVisualSegment(void* const segment) const
{
	return ((dgList<dgMeshSegment>::dgListNode*) segment)->GetNext();
}


dgInt32 dgCollisionDeformableClothPatch::GetSegmentMaterial (void* const segment) const
{
	const dgMeshSegment& info = ((dgList<dgMeshSegment>::dgListNode*) segment)->GetInfo();
	return info.m_material;
}

dgInt32 dgCollisionDeformableClothPatch::GetSegmentIndexCount (void* const segment) const
{
	const dgMeshSegment& info = ((dgList<dgMeshSegment>::dgListNode*) segment)->GetInfo();
	return info.m_indexCount;
}

const dgInt16* dgCollisionDeformableClothPatch::GetSegmentIndexList (void* const segment) const
{
	const dgMeshSegment& info = ((dgList<dgMeshSegment>::dgListNode*) segment)->GetInfo();
