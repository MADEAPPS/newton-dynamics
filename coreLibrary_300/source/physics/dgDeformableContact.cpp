...
dgDeformableContact::dgDeformableContact(dgWorld* const world, const dgContactMaterial* const material)
	:dgContact(world, material)
{
}


dgDeformableContact::~dgDeformableContact()
{
}
