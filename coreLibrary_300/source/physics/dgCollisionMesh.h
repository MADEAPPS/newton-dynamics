...
class dgCollisionMesh: public dgCollision  
{
	...
	virtual dgFloat32 ConvexRayCast (const dgCollisionInstance* const convexShape, const dgMatrix& origin, const dgVector& veloc, dgFloat32 minT, dgContactPoint& contactsOut, const dgBody* const referenceBody, const dgCollisionInstance* const referenceShape, void* const userData) const
	{
		dgAssert (0);
		return  minT;
	}
