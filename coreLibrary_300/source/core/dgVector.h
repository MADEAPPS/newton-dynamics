...
class dgTemplateVector
{
	public:
	dgTemplateVector ();
	dgTemplateVector (const T* const ptr);
...
class dgBigVector: public dgTemplateVector<dgFloat64>
{
	...
	dgBigVector (const dgFloat32* const ptr);
#ifndef __USE_DOUBLE_PRECISION__
	dgBigVector (const dgFloat64* const ptr);
#endif
...
DG_INLINE dgBigVector::dgBigVector (const dgFloat32* const ptr)
...
#ifndef __USE_DOUBLE_PRECISION__
DG_INLINE dgBigVector::dgBigVector (const dgFloat64* const ptr)
