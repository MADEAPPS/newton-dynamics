...
dgVector dgHingeConstraint::GetJointForce () const
{
	...
	return dgVector (matrix0.m_front.Scale (m_jointForce[0].m_force____) + 
		             matrix0.m_up.Scale (m_jointForce[1].m_force____) + 
					 matrix0.m_right.Scale (m_jointForce[2].m_force____) +
					 matrix0.m_up.Scale (m_jointForce[3].m_force____) +
					 matrix0.m_right.Scale (m_jointForce[4].m_force____));
}
