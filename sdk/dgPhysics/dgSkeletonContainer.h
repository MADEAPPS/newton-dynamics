...
class dgSkeletonContainer
{
	...
	void SolveLcp(dgInt32 size, const dgFloat32* const matrix, dgFloat32* const x, const dgFloat32* const x0, const dgFloat32* const b, const dgFloat32* const low, const dgFloat32* const high, const dgInt32* const normalIndex) const;
