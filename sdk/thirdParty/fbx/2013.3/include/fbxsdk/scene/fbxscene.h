...
public:
    ...
    */
    ...
    /** Get the scene information.
      ...
      */
    inline FbxDocumentInfo* GetSceneInfo() { return GetDocumentInfo(); }

    /** Set the scene information.
      * \param pSceneInfo Pointer to the scene information object.
      */
    inline void SetSceneInfo(FbxDocumentInfo* pSceneInfo) { SetDocumentInfo(pSceneInfo); }
    ...
    /** Helper method for determining the number of nodes that have
      ...
      * nodes are connected to nurbs geometry and not any FbxNode in the
...
private:
    ...
    void ConnectTextureLayerElement(FbxLayerContainer* pLayerContainer,
                                    FbxLayerElement::EType pLayerType,
                                    FbxNode* pParentNode);

    void BuildTextureLayersDirectArrayForLayerType(FbxLayerContainer* pLayerContainer,
                                                   FbxLayerElement::EType pLayerType);
