...
/** This is the interface for implementation of animation key objects.
  ...
  * for an example of implemented class, please see FbxAnimCurveKFCurveKey.
  * For the time being, FbxAnimCurveKFCurveKey encapsulates the legacy KFCurveKey structure for backward compatibility.
...
public:
	...
	* \remarks For the time being, FbxAnimCurveDef::EDataIndex is defined according to the legacy 
	*  KFCurveKey for backward compatibility. However, this is subject to change.
	*
	* \see The documentation of FbxAnimCurveKFCurveKey::GetDataFloat().
	*
	* \code
	...
	* \see The documentation of FbxAnimCurveKFCurveKey::SetDataFloat().
	* 
	* \code
	* FbxAnimCurveKey* lKey; // we suppose this is a valid pointer
...
/** This is the interface for the FBX animation curve keys.
  ...
  * for the time being, FbxAnimCurveKey_Impl is implemented by FbxAnimCurveKFCurveKey,
  * and FbxAnimCurveKFCurveKey encapsulates the legacy KFCurveKey structure for backward compatibility.
  * However, this implementation is subject to change.
...
public:
	...
	*/
	...
	/** Get key implementation.
      * \return Pointer to implemented instance, e.g. a FbxAnimCurveKFCurveKey.
      */
...
public:
	...
	//@{
		/** Create a FbxAnimCurve.
		  ...
		  */
		static FbxAnimCurve* Create(FbxScene* pContainer, char const *pName);
	//@}
