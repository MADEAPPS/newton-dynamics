...
/** This class is deprecated.
  * \see FbxLayerElementTexture
  */
typedef class FBXSDK_DLL FbxLayerElementTemplate<FbxTexture*>  FbxLayerElementTextureBase;
...
/** \brief Layer element for mapping Textures to a geometry. This class is deprecated.
  ...
  * \nosubgrouping
  */
class FBXSDK_DLL FbxLayerElementTexture : public FbxLayerElementTextureBase
{
...
*****************************************************************************************************************************/
	...
	virtual int MemorySize() const
	{
		int size = FbxLayerElementTextureBase::MemorySize();
