...
protected:
    virtual void Construct(const FbxBoundary* pFrom);

    void Reset();

    bool LineSegmentIntersect( const FbxVector4 & pStart1, const FbxVector4 & pEnd1,
                               const FbxVector4 & pStart2, const FbxVector4 & pEnd2 ) const;
