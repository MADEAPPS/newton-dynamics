...
public:
	...
	//@{
		...
		* \return A pointer to the scene that contains this object or \c NULL if the object does not belong to any scene. */
		...
		/** Unregister and delete this object. This will also breaks all connections as well as removing all the instance of all the properties of this object with the object's class.
		* \param pRecursive If true, all children (or sources) objects will also be unregistered and deleted. */
