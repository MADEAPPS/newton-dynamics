...
void AnimateLight(FbxNode* pLight, int pIndex, FbxAnimLayer* pAnimLayer)
{
    ...
    // Color cycling.
    {
        ...
        lCurve[0] = light->Color.GetCurve(pAnimLayer,FBXSDK_CURVENODE_COLOR_RED, true);
        lCurve[1] = light->Color.GetCurve(pAnimLayer,FBXSDK_CURVENODE_COLOR_GREEN, true);
        lCurve[2] = light->Color.GetCurve(pAnimLayer,FBXSDK_CURVENODE_COLOR_BLUE, true);
