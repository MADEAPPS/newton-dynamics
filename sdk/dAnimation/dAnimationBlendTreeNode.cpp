...
/*
dAnimationBlendTreeNode::dAnimationPose::dAnimationPose()
...
void dAnimationBlendTreeNode::dAnimationPose::CopySource(const dAnimationPose& source)
{
	dAssert (0);
...
void dAnimationBlendTreeNode::dAnimationPose::SetTargetPose() const
{
	dAssert (0);
